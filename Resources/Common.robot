...
Plan Page UI Verification
    ...
    FOR     ${i}    IN RANGE   1  ${length}+1
        ...
        ${packname}=  Run Keyword And Ignore Error  Take Element Text          xpath=(//section[contains(@class,'desktop')]//div[@class="Subcategory_gridCont__2F4Pm"]//div[contains(@class,"Subcategory_heading")])   
...
Product Redirection
    [Arguments]    ${Product-locator}       ${Product Name-locator}     ${Product Title}
    Wait For And Click Element      ${Product-locator}
    Wait For And Verify Content     ${Product Name-locator}    ${Product Title}  
