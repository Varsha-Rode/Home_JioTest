...
In the Spotlight Section Validation
    ...
    # #Banner subtext verification
    # Text Verification                          xpath=//div[@class="j-color-primary-grey-80 j-contentBlock__description j-text-body-m" and contains(text( ),"Jio Extender")]               ${Spotlight_text[3]}

    #Redirection to Product page
    Redirection On Clicking for Home             xpath=//button[@class="j-button j-button-size__medium primary flex-grow-0 w-auto "]    https://www.jiocinema.com/    Spotlight_Redirection
