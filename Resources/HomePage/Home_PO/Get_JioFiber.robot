...
Get Jio Fiber Popup Validation
    ...
    #Special Offer
    #Wait For And Verify Element            xpath=//div[@class='j-card size--xs card-vertical']
    
    #Sub Text Verification Below Get Jio Fiber 
    Text Verification                       xpath=//*[@id="generate-number-wrapper-id"]//div[@class="j-contentBlock__description j-text j-text-body-xs"]    Just validate your number, share your address, and we'll get JioFiber installed at your place soon.
    ...
    InputText                               xpath=//input[@id='user-name-fiber']            ${Name} 
    InputText                               xpath=//input[@id='user-number-fiber']          ${Incorrect_No2}       
    ...
    Wait For And Input Text                 xpath=//input[@id='user-number-fiber']          ${Incorrect_No1}
    Wait For And Click Element              xpath=//button[@id='generateOTP-btn-fiber']
    Text Verification                       xpath=//div[@id='user-number-invalid-fiber']      Please enter a valid mobile number
    Wait For And Input Text                 xpath=//input[@id='user-name-fiber']            ${Name}
    ...
    ELSE
        ...
        #entering otp
        FOR  ${i}   IN RANGE  1  7
            Wait For And Input Text         xpath=//input[@id='otpnumberinputfiber-${i}']           ${i}
        END  
        ...
        Wait For And Click Element          xpath=//div[@id='modal-get-fiber-container']//a[contains(@onclick,'resend')]
