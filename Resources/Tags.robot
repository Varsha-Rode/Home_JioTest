...
Tags Activity
    ...
    ...    file_path=C:/Users/Saravanan.Iyer/Documents/GitHub/Shop_Support_Merged_TC/Resources/Tags.xlsx
    ...
    ${TC14-Home}=    Adjacent Cell Value
    ...    file_path=C:/Users/Saravanan.Iyer/Documents/GitHub/Shop_Support_Merged_TC/Resources/Tags.xlsx
    ...    sheet_name=PivotTable
    ...    name=TC14-Home
    Set Global Variable    ${TC14-Home}
    ...
    ${TC71-DMiscover}=    Adjacent Cell Value
    ...    file_path=C:/Users/Saravanan.Iyer/Documents/GitHub/Shop_Support_Merged_TC/Resources/Tags.xlsx
    ...    sheet_name=PivotTable
    ...    name=TC71-DMiscover
    Set Global Variable    ${TC71-DMiscover}
    ...
    ${TC02-MPrepaid}=    Adjacent Cell Value
    ...    file_path=C:/Users/Saravanan.Iyer/Documents/GitHub/Shop_Support_Merged_TC/Resources/Tags.xlsx
    ...    sheet_name=PivotTable
    ...    name=TC02-MPrepaid
    Set Global Variable    ${TC02-MPrepaid}
    ...
    Set Global Variable    ${TC168-MPrepaid}
     ${TC23-MPrepaid}=    Adjacent Cell Value    file_path=C:/Users/Saravanan.Iyer/Documents/GitHub/Shop_Support_Merged_TC/Resources/Tags.xlsx  
     ...    sheet_name=PivotTable
     ...    name=TC23-MPrepaid
    ...
    ${TC03-MRecharge}=    Adjacent Cell Value
    ...    file_path=C:/Users/Saravanan.Iyer/Documents/GitHub/Shop_Support_Merged_TC/Resources/Tags.xlsx
    ...    sheet_name=PivotTable
    ...    name=TC03-MRecharge
    Set Global Variable    ${TC03-MRecharge}
...
#SHOP
    ...
    ${TC51-SSmart Devices}=    Adjacent Cell Value
    ...    file_path=C:/Users/Saravanan.Iyer/Documents/GitHub/Shop_Support_Merged_TC/Resources/Tags.xlsx
    ...    sheet_name=PivotTable
    ...    name=TC51-SSmart Devices
    Set Global Variable    ${TC51-SSmart Devices}
    ${TC27-SSmart Devices}=    Adjacent Cell Value
    ...    file_path=C:/Users/Saravanan.Iyer/Documents/GitHub/Shop_Support_Merged_TC/Resources/Tags.xlsx
    ...    sheet_name=PivotTable
    ...    name=TC27-SSmart Devices
    Set Global Variable    ${TC27-SSmart Devices}
    ${TC30-SSmart Devices}=    Adjacent Cell Value
    ...    file_path=C:/Users/Saravanan.Iyer/Documents/GitHub/Shop_Support_Merged_TC/Resources/Tags.xlsx
    ...    sheet_name=PivotTable
    ...    name=TC30-SSmart Devices
...
####FIBER
    ...
    ${TC01-Paybills}=    Adjacent Cell Value
    ...    file_path=C:/Users/Saravanan.Iyer/Documents/GitHub/Shop_Support_Merged_TC/Resources/Tags.xlsx
    ...    sheet_name=PivotTable
    ...    name=TC01-Paybills
    Set Global Variable    ${TC01-Paybills}
    ${TC11-Paybills}=    Adjacent Cell Value
    ...    file_path=C:/Users/Saravanan.Iyer/Documents/GitHub/Shop_Support_Merged_TC/Resources/Tags.xlsx
    ...    sheet_name=PivotTable
    ...    name=TC11-Paybills
    Set Global Variable    ${TC11-Paybills}
    ${TC16-Paybills}=    Adjacent Cell Value
    ...    file_path=C:/Users/Saravanan.Iyer/Documents/GitHub/Shop_Support_Merged_TC/Resources/Tags.xlsx
    ...    sheet_name=PivotTable
    ...    name=TC16-Paybills
    Set Global Variable    ${TC16-Paybills}
    ...
    ${TC01-FRecharge}=    Adjacent Cell Value    file_path=C:/Users/Saravanan.Iyer/Documents/GitHub/Shop_Support_Merged_TC/Resources/Tags.xlsx    
    ...    sheet_name=PivotTable   
    ...    name=TC01-FRecharge
